 ...
 * @returns
 */
const importSheet = (filename, descriptionColumn, amountColumn, dateColumn) => {
	// Load the workbook
	// TODO: - app config
	...
	return XLSX.utils.sheet_to_json(worksheet).map((x) => ({
		TransactionDate: helper.excelDateToJSDate(x[dateColumn]),
		Description: x[descriptionColumn],
		Amount: x[amountColumn],
	}))
}
/**
